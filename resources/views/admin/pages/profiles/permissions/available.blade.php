...
@section('content_header')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.profiles.permissions', $profile->id) }}">Permissões</a></li>
...
@section('content')
    <div class="card">
        <div class="card-header">
            <form action="{{ route('admin.profiles.permissions.available', $profile->id) }}" class="form form-inline" method="post">
                @csrf
